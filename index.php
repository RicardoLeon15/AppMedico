<?php
     ...
     class AppMedica{
         function __construct(){
            ...
            if(strcmp($url[0],"listaMedicos")==0||strcmp($url[0],"agregarMedico")==0||strcmp($url[0],"acercaDeA")==0){
            ...
            if(strcmp($url[0],"agregarPaciente")==0||strcmp($url[0],"listaPacientes")==0||strcmp($url[0],"acercaDeM")==0){
